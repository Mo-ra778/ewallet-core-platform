                ...
                <table class="w-full text-right text-xs">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50/60 transition">
                            ...
                            <td class="py-3.5 px-4 text-center">
                                <button type="button" onclick="showConfirmDialog({ title: 'حذف زوج الصرف', message: 'هل أنت متأكد من حذف زوج الصرف ({{ $r->from_currency }} -> {{ $r->to_currency }}) نهائياً؟', confirmText: 'نعم، حذف الزوج', confirmType: 'danger', onConfirm: () => document.getElementById('delete-rate-{{ $r->id }}').submit() });"
